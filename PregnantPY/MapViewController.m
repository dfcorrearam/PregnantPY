...
- (void)viewDidLoad {
    ...
    [mapView addSubview:button];
    [mapView addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"H:[button(44)]-|" options:0 metrics:nil views:NSDictionaryOfVariableBindings(button)]];
    [mapView addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"V:[button(44)]-|" options:0 metrics:nil views:NSDictionaryOfVariableBindings(button)]];
